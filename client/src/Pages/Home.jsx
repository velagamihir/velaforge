        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            {services.map(({ icon: Icon, title, description, features }) => (
              <li
                key={title}
                className="group flex flex-col rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-shadow duration-200 hover:shadow-md dark:border-white/10 dark:bg-gray-900"
              >
                {/* Icon */}
                <div className="bg-primary mb-5 inline-flex h-14 w-14 items-center justify-center rounded-xl text-white shadow-md">
                  <Icon
                    className="h-6 w-6"
                    aria-hidden="true"
                    strokeWidth={1.75}
